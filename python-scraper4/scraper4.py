...
APP_VERSION = "10.176"
CHANGELOG = [
    {"version":"10.176","date":"2026-09-20","title":"رفع گیر کردن تست سه‌صفحه‌ای روی مرحلهٔ اول","items":["رابط این تست را به‌صورت زنده می‌خواند و انتظار گزارش مرحله‌به‌مرحله دارد، اما سرور فقط یک پاسخ در پایان می‌فرستاد","نتیجه: پنل زنده روی جملهٔ «در حال شروع درخواست» می‌ماند تا کل تست تمام شود و کاربر فکر می‌کرد گیر کرده","حالا هر موتور به‌محض پایان، نتیجه‌اش را زنده گزارش می‌کند؛ ۱۸ رویداد به‌جای یک پاسخ",
     "عیب‌یابی هم همین مشکل را داشت ولی چون سریع بود دیده نمی‌شد؛ آن هم زنده شد","درخواست‌های غیرزنده مثل قبل یک پاسخ JSON می‌گیرند"]},
