...
export async function browserRepairReport({cwd=process.cwd(),env=process.env,state={},network={},version='',head='',resolveExecutable=()=>undefined}={}){
 ...
 const flags={};for(const key of ['PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD','PUPPETEER_SKIP_DOWNLOAD','PLAYWRIGHT_DOWNLOAD_CONNECTION_TIMEOUT','VISUAL_BROWSER_NO_SANDBOX'])if(env[key]!==undefined)flags[key]=env[key];
