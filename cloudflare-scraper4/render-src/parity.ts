import { databaseLabel, pool } from './db.js';
...
export const PHP_MENU_CAPABILITIES:Capability[]=[
 ...
 {id:'version-check',section:'version',label:'بررسی نسخه کد',status:'adapted',note:'وضعیت انتشار همین اجراگر'},
 {id:'version-update',section:'version',label:'نصب نسخه جدید',status:'adapted',note:'به‌روزرسانی/بازگشت خودکار همین اجراگر'},
 {id:'backup-full',section:'backup',label:'بکاپ کامل داده',status:'operational',endpoint:'/api/backup'},
 {id:'backup-restore',section:'backup',label:'بازیابی بکاپ',status:'operational',endpoint:'/api/restore'},
