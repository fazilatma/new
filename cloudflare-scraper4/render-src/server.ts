...
const PACKAGE_VERSION = (() => { try { return JSON.parse(readFileSync(new URL('../package.json', import.meta.url), 'utf8')).version || '1.129.0'; } catch { return process.env.npm_package_version || '1.129.0'; } })();
