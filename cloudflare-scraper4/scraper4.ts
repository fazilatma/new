 ...
 *   4) Open /health and verify version is 1.152.0.
 *
...
type ExtractionEngine = "auto" | "htmlrewriter" | "jsonld" | "next_data" | "metadata" | "script_json" | "heuristic" | "playwright" | "puppeteer" | "crawlee_playwright";
type Profile = {
...
const EXTRACTION_ENGINES: ExtractionEngine[] = ["auto", "htmlrewriter", "jsonld", "next_data", "metadata", "script_json", "heuristic", "playwright", "puppeteer", "crawlee_playwright"];
